    ...
    <div className='border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100'>
      ...
      <div className='flex gap-12 sm:gap-12 flex-col sm:flex-row'>
        ...
        <div className='flex-1'>
          ...
          <div>
            ...
            <p>Easy return and exchange Poolicy within 7 days.</p>
          </div>          
        </div>
      </div>
      ...
      <div className='mt-20'>
        ...
        <div className='flex flex-col gap-4 border px-6 py-6 text-sm text-gary-500'>
          ...
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. A excepturi delectus quia quo accusantium corrupti.</p>
        </div>
      </div>
